package com.foora.perevozkadev.utils.custom.pager_adapter;
...
public abstract class ArrayFragmentStatePagerAdapter<T> extends ArrayPagerAdapter<T> {
    ...
    public boolean isViewFromObject(View view, Object object) {
        return object == view.getTag(R.id.view_tag_key);
    }
    ...
    private static class SerializableItemStateHandler implements ItemsStateHandler<Serializable> {
    ...
    private static class ParcelableItemStateHandler implements ItemsStateHandler<Parcelable> {
    ...
    private Fragment findFragmentByItem(Object item) {
        ...
        for (Fragment fragment : fragments) {
            if (fragment != null) {
                ...
                if (view != null && item == view.getTag(R.id.view_tag_key)) {
                    return fragment;
                }
            }
        }
    ...
    private void setTags(List<IdentifiedItem<T>> items) {
        for (int i = 0; i < mFragments.size(); i++) {
            ...
            if (fragment != null && fragment.getView() != null) {
                fragment.getView().setTag(R.id.view_tag_key, items.get(i));
            }
        }
    }
}