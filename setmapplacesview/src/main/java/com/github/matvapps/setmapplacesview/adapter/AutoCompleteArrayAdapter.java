...
public class AutoCompleteArrayAdapter extends ArrayAdapter {
    public static final String TAG = AutoCompleteArrayAdapter.class.getSimpleName();
    private List<Place> dataList;
    private Context mContext;
    private GeoDataClient geoDataClient;

    private AutoCompleteArrayAdapter.CustomAutoCompleteFilter listFilter =
            new AutoCompleteArrayAdapter.CustomAutoCompleteFilter();
